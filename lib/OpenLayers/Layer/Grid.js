...
OpenLayers.Layer.Grid = OpenLayers.Class(OpenLayers.Layer.HTTPRequest, {
     ...
     * removetile - Triggered when a tile is removed from this layer. Listeners
     *     receive an object as first argument, which has a tile property that
     *     references the tile that has been removed.
    ...
    destroyTile: function(tile) {
        ...
        this.events.triggerEvent("removetile", {tile: tile});
        tile.destroy();
    },
